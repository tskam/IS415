---
title: 'IS415 Hands-on Exercise 3:'
...
In this hands-on exercise, you will learn how to perform choropleth mapping using [**tmap**](https://cran.r-project.org/web/packages/tmap/) package in R.      
...
Beside **tmap** package, four other R packages will be used, they are: [**readr**](https://readr.tidyverse.org/), [**tidyr**](https://tidyr.tidyverse.org/), [**dplyr**](https://dplyr.tidyverse.org/) and [**sf**](https://cran.r-project.org/web/packages/sf/index.html).  Among the four packages, **readr**, **tidyr** and **dplyr** are part of **tidyverse** package.
