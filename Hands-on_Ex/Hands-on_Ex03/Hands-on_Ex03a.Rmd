...
description: |
  In this hands-on exercise, you will learn how to plot functional and truthful choropleth maps by using an R package called **tmap** package.  
date: "`r Sys.Date()`"
output:
...
```{r}
mpszpop2020 <- write_rds("data/rds/mpszpop2020.rds")
```
...
library(pagedown)
pagedown::chrome_print("Hands-on_Ex03a.html")
```
