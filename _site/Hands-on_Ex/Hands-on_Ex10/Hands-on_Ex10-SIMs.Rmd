...
- Spatial data handling
    - sf, sp, [geojsonio](https://cran.r-project.org/web/packages/geojsonio/index.html), [stplanr](https://docs.ropensci.org/stplanr/index.html).
...
**Note:** **stplanr** was removed from cran recently.  The latest version is 0.8.4.  Use the code chunk above to install **stplanr** if this is the first time installation.  
...
Technically, we can used *st_distance()* of **sf** package to compute the distance matrix.  However, I notice that the process took much longer time to complete.  In view of this, *spDist()* of **sp** package is used.  
