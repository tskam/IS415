...
description: In this hands-on exercise, you will learn how to compute Global and Local Measures of Spatial Autocorrelation by using spdep package. 
author:
...
In the code chunk below [*histo()*](https://www.rdocumentation.org/packages/graphics/versions/3.6.2/topics/hist) and [*abline()*](https://www.rdocumentation.org/packages/graphics/versions/3.6.2/topics/abline) of R Graphics are used.
...
library(pagedown)
pagedown::chrome_print("Hands-on_Ex07-GLSA.html")
```
