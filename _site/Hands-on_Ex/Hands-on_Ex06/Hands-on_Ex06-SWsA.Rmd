...
description: In this hands-on exercise, you will learn how to derive spatial weights by using functions provided by spdep package.  You will also learn how to apply these spatial weights to compute spatially lagged values. 
author:
...
```{r eval=FALSE}
lag.list.knn6a <- list(hunan$NAME_3, lag.listw(wm_knn6a, hunan$GDPPC))
...
library(pagedown)
pagedown::chrome_print("Hands-on_Ex06-SWsA.html")
```
