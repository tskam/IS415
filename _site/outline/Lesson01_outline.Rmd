...
description: |
  This lesson introduces Geospatial Analytics
date: "`r Sys.Date()`"
output:
...
Lesson slide in [html](../lesson/lesson01/Lesson01-Introduction_to_GAA.html) and [pdf](../lesson/lesson01/Lesson01-Introduction_to_GAA.pdf) formats

In-class Exercise in [html]() format.
