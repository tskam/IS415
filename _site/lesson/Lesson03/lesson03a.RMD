...
write_rds(mpszpop2020,"data/rds/mpszpop2020.rds")
```
...
Chloropleth map on the right  is plotted by using *classic* style.
...
In this example, multiple small choropleth maps are created by creating multiple stand-alone maps with [**tmap_arrange()**](https://rdrr.io/cran/tmap/man/tmap_arrange.html). 
...
```{r echo=FALSE, eval=FALSE}
library(pagedown)
pagedown::chrome_print("Lesson03a.html")
```