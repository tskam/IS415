...
![:scale 50%](img/image10-6d.jpg)

![:scale 75%](img/image10-6e.jpg)
]
...
.center[
![:scale 85%](img/image10-6f.jpg)

and the calculation T11

![:scale 50%](img/image10-6g.jpg)
]]
...
.center[
![:scale 80%](img/image10-7a.jpg)

A1 is calculated as shown below:

![:scale 75%](img/image10-7b.jpg)


Hence, T11 is calculated as shown below:

![:scale 45%](img/image10-7c.jpg)
]]
...
.center[
![:scale 80%](img/image10-8b.jpg)

B1 is calculated as shown below:

![:scale 75%](img/image10-8c.jpg)


Hence, T11 is calculated as shown below:

![:scale 45%](img/image10-8d.jpg)
]]
...
.center[
![:scale 80%](img/image10-9b.jpg)


Hence, T11 is calculated as shown below:

![:scale 55%](img/image10-9c.jpg)
...
library(pagedown)
pagedown::chrome_print("Lesson10-SIMs.html")
```