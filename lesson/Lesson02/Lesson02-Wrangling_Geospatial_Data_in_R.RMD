---
title: 'Lesson 2: Wrangling Geospatial Data in R'
...
???
It is important for us to note that waht ever data capsture in a database is a model of the real world.  When we say model, this means that it is a simplify version of the real world and not the real world themsellves. 
...
.center[
![:scale 80%](img/image2-11.jpg)]

---
### Simple Features: How they look like?
.center[
![:scale 85%](img/image2-12.jpg)]
...
.center[
![:scale 50%](img/image2-10.jpg)
]

---
### sf package dependencies 
.center[
![:scale 70%](img/image2-22.jpg)
...
* [Tidy spatial data analysis](https://github.com/edzer/rstudio_conf)
