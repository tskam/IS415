...
- Submission of final application, user guide, project poster, practice research paper and artifacts: **19th November 2021 by 11:59pm (mid-night)**
...
The project poster must be prepared by using [posterdown](https://github.com/brentthorne/posterdown/wiki).  The final output format of the poster must be in **pdf** format.
...
### Group 1
[Spatial Interaction Model](https://flosg-is415.netlify.app/)

### Group 3
[Regionalisation in Reach](https://is412-g3-proposal.netlify.app/posts/welcome/)

### Group 5
[Geographically Weighted Regression](https://g5-is415-proj.netlify.app/)

### Group7
[GeoeXplorer](https://geoxplorer.netlify.app/), a web-enabled geospatial analytics toolkit for detecting and visualising global spatial autocorrelation and local clusters and outliers from univariate geographically referenced data.

### Group 8
[Spatial Pointers](https://spatial-pointers.netlify.app/project-proposal), a web-enabled Spatial Point Patterns Analysis toolkit for visualising and analysing both spatial and network constrained point patterns.


```{r echo=FALSE, eval=FALSE}
library(pagedown)
pagedown::chrome_print("_site/GAproject.html")
```
