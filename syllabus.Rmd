...
- Design and implement web-based geospatial analytics applications. 
...
24.	Designing geospatial application programmatically by using free and open source software and packages (i.e. R, R packages and Shinny).
